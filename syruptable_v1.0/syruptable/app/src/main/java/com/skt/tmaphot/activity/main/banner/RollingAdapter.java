...
public class RollingAdapter extends PagerAdapter {
    ...
    private List<RollingModel> mList;
        ...
        if(pos == count + 1 || pos == count + count + 1){
            if(mViewMap != null && mViewMap.get(key) != null){
                ...
                if(key != null && layout.getTag() != null && !object.getKey().equals(layout.getTag())){
                    ...
                    params.width = BaseApplication.getInstance().getImageWidthFitXYSize(999,1140);
                    params.height = BaseApplication.getInstance().getImageHeightFitXYSize(999, 1140);
                    imageView.setLayoutParams(params);

//                    imageView.setAdjustViewBounds(true);
                    BaseApplication.getInstance().loadImage(mContext, object.getResId(), imageView, false, BaseApplication.getInstance().DEFAULT_ORIGINAL);
                }
                return layout;
            }
        }
