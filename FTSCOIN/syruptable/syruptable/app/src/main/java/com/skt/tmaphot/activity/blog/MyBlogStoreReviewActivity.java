...
//    private List<SocialReviewItem> socialReviewItemList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener()
        {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels)
            {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        imageCount.setText( (mViewPager.getCurrentItem() + 1) +"/"+ imageUrlList.size());
                    }
                });
            }
        ...
        imageCount = (TextView)findViewById(R.id.viewpager_image_count_txt);
...
//            Intent intent = ;
            startActivity(new Intent(MyBlogStoreReviewActivity.this , ImageViewPagerActivity.class));
        }
    }
