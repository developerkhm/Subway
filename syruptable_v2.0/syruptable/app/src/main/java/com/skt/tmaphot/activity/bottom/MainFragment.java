...
import com.skt.tmaphot.net.model.hotplace.HotplaceBean;
...
//    private String small_cd;
    private String cate = new String();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.d("BCA12", "onCreateView MainFragment");
...
//            hotplace_bottom_more.setText(CommonUtil.getInstance().decimalFormat(hotPlaceRecyclerViewDataAdapter.getDatatotalCount()) + " 개 더보기");
        ...
        APIClient.getInstance().getClient2(null).getHotplaceList(hotplace_curruntPage, per_page, GPSData.getInstance().getLatitude(), GPSData.getInstance().getLongitude(), hotplace_sortType, cate)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<List<HotplaceBean>>() {
                    @Override
                    ...
                    @Override
                    public void onNext(List<HotplaceBean> hotplaceBeans) {
                        hotPlaceRecyclerViewDataAdapter.loadData(hotplaceBeans);
                    }
    ...
    public void hotplaceSet() {
        ...
        hotPlaceRecyclerViewDataAdapter = new HotPlaceRecyclerViewDataAdapter(new ArrayList<HotplaceBean>());
...
//    };
    ...
    MainMenuRecyclerViewDataAdapter.OnEventCilckListener onEventCilckListener = new MainMenuRecyclerViewDataAdapter.OnEventCilckListener() {
        @Override
        public void menuOnClick(MainMenuRecyclerViewItem mainMenuRecyclerViewItem) {
            cate = mainMenuRecyclerViewItem.getCate();
//            middle_cd = mainMenuRecyclerViewItem.getMiddle_cd();
//            small_cd = mainMenuRecyclerViewItem.getSmall_cd();
