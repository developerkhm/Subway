...
public class HotPlaceRecyclerViewDataAdapter extends RecyclerView.Adapter<HotPlaceRecyclerViewHolder> {
    ...
    private List<HotplaceBean> viewItemList = new ArrayList<>();


    public HotPlaceRecyclerViewDataAdapter(List<HotplaceBean> hotplaceBeans) {
        this.viewItemList.addAll(hotplaceBeans);
    }
    ...
    public void onBindViewHolder(HotPlaceRecyclerViewHolder holder, final int position) {
        BaseApplication.getInstance().loadImage(mContext, viewItemList.get(position).getImageUrl(), holder.mImgUrl, false, BaseApplication.getInstance().LIST_HORIZONTAL_HOTPLACE);
    ...
    public void loadData(List<HotplaceBean> hotplaceBeans) {
        this.viewItemList.addAll(hotplaceBeans);
