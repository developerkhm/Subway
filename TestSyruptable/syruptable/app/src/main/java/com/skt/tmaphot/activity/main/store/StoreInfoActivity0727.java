...
public class StoreInfoActivity0727 extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new RollingAdapter(StoreInfoActivity0727.this, getData(), new RollingAdapter.OnAdapterItemClickListener() {
            @Override
            public void onItemClick(RollingModel object, int position) {
                Toast.makeText(StoreInfoActivity0727.this, position + " items click!", Toast.LENGTH_SHORT).show();
            }
        });
...
//            Intent intent = ;
            startActivity(new Intent(StoreInfoActivity0727.this , StoreInfoImageViewActivity.class));
        }
    }
